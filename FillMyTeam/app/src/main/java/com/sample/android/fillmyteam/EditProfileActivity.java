...
public class EditProfileActivity extends BaseOptionsActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.time:
                ...
                newFragment.show(this.getFragmentManager(), Constants.TIME_PICKER);
                break;
